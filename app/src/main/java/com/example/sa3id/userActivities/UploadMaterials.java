...
import static com.example.sa3id.models.UploadRequest.getCurrentTimestamp;
...
public class UploadMaterials extends BaseActivity {
    ...
    private void initViews() {
        ...
        etSubject = findViewById(R.id.etSubjectSpinner);
        ...
        databaseReference = firebaseDatabase.getReference("upload_requests");
    }
    ...
    private void saveRequestToDatabase(String description, ArrayList<String> fileUrls) {
        String selectedSubject = etSubject.getText().toString();
        String descriptionWithSubject = "المادة: " + selectedSubject + "\n" + description;

        UploadRequest uploadRequest = new UploadRequest(descriptionWithSubject, fileUrls, firebaseUser.getEmail(), requestTimeStamp);
        uploadRequest.setSubject(selectedSubject);
